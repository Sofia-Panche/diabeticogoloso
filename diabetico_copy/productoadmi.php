...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sabor_crema = intval($_POST['sabores_crema']); 
    $sabor_relleno = intval($_POST['sabores_relleno']);  
...
<div class="product-container">
    ...
    <div class="product-details">
        ...
        <form method="POST">
            ...
            <select id="sabor_crema" name="sabores_crema"> 
            ...
            <select id="sabor_relleno" name="sabores_relleno"> 
