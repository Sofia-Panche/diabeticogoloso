...
.consultas{
   ...
   <header>
       <div class="top-bar">
        ...
        <div class="main-nav">
            <nav>
            <a class="consultas" href="identificarse.php">inicia sesion</a>    
         
            <a class="consultas" href="1nosotros.php">Sobre nosotros</a>
            </nav>
            <div class="icons-container">
                <a href="carrito2.php"><i class="fa-solid fa-cart-shopping"></i> (<?= array_sum(array_column($carrito, 'cantidad')) ?>)</a>
        </div>
    </header>
