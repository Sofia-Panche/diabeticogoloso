    ...
    <main>
        <section class="bienvenida">
            <div class="bienvenida-content">
                <h2 class="hh22">Bienvenido a El Diabético Goloso</h2>
            </div>
        </section>
        ...
        <div class="coso-de-arriba"><h2>Disfruta tu torta personalizada en 3 pasos 😉</h2></div>
         <section class="coso-del-centro">
            ...
            <div class="pasos">
                ...
                <h4 class="texto" >3 - Envianos la imagen e información a nuestro WhatsApp 310763278</h4>
                <button class="boton-wasap" type="submit"><a href="https://wa.me/message/P47BCD67AG3FC1">clic a WhatsApp</button>
            </div>
</section>
        ...
        <div class="productos">
            <?php foreach ($productos as $id => $producto): ?>
                <div class="producto">
                    ...
                    <form action="descripcionpersonalizadas.php" method="post">
                        <input type="hidden" name="producto_id" value="<?= $id ?>">
                        <button type="submit"><a href="#"><i class="fa-solid fa-cart-shopping"></i></button>
                    </form>
                </div>
            <?php endforeach; ?>
            </div>
